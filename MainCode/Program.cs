...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        IProductRepository _repo = new SqlProductRepository(_connectionString);
    ...
    static async Task AddProduct(IProductRepository repo)
    {
    ...
    static async Task ViewAllProducts(IProductRepository repo)
    {
    ...
    static async Task EditProduct(IProductRepository repo)
    {
    ...
    static async Task DeleteProduct(IProductRepository repo)
    {
    ...
    static async Task SearchProduct(IProductRepository repo)
    {
